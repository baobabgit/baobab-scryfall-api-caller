"""Client technique pour appeler les endpoints Rulings via baobab-web-api-caller."""
...
class RulingsApiClient:
    """Encapsule les appels HTTP du domaine rulings."""
    ...
    def __init__(
        ...
        *,
        ...
        """Initialise le client technique Rulings."""
